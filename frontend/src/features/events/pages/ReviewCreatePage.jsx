        ...
        <div className="review-create__card">
          ...
          <form className="review-create__form" onSubmit={handleSubmit}>
            <div className="review-create__section">
              ...
              <div className="review-create__section-body">
                <div className="review-create__stars" role="radiogroup" aria-label="평점 선택">
                  {[1, 2, 3, 4, 5].map((value) => (
                    <button
                      key={value}
                      type="button"
                      className={value <= rating ? 'review-create__star is-active' : 'review-create__star'}
                ...
                <p className="review-create__rating-text">{rating}점을 선택했어요.</p>
              </div>
            </div>
            ...
            <div className="review-create__section">
              ...
              <div className="review-create__section-body">
                <textarea
                  ...
                  placeholder="행사에서 좋았던 점이나 인상 깊었던 부분을 남겨주세요."
                  value={content}
